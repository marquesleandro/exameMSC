...
\begin{tikzpicture}
 ...
 \node[square, draw, inner sep=0pt, minimum size=8pt] at (0.2,1) {};
 \node[square, draw, inner sep=0pt, minimum size=8pt] at (1.1,1) {};
 \node[square, draw, inner sep=0pt, minimum size=8pt] at (2.3,1) {};
 \node[square, draw, inner sep=0pt, minimum size=8pt] at (3.8,1) {};
 \node[square, draw, inner sep=0pt, minimum size=8pt] at (4.9,1) {};
 \node[square, draw, inner sep=0pt, minimum size=8pt] at (5.8,1) {};

 % dotted line
 \draw [dotted] (0,0) -- (0.2,1);
 \draw [dotted] (1,0) -- (1.1,1);
 \draw [dotted] (2.7,0) -- (2.3,1);
 \draw [dotted] (4,0) -- (3.8,1);
 \draw [dotted] (5.1,0) -- (4.9,1);
 \draw [dotted] (6,0) -- (5.8,1);

 % legend
 \draw [latexnew-latex] (-0.3,0) -- (-0.3,1);
 \node at (-0.5,0.5) {t};
 \node at (3,-0.5) {\scriptsize (a)};
 % -------------------------------------------------------------------
