...
\begin{tikzpicture}
 ...
 \node[square, draw, inner sep=0pt, minimum size=8pt] at (0,0) {};
 \node[square, draw, inner sep=0pt, minimum size=8pt] at (1,0) {};
 \node[square, draw, inner sep=0pt, minimum size=8pt] at (2.7,0) {};
 \node[square, draw, inner sep=0pt, minimum size=8pt] at (4,0) {};
 \node[square, draw, inner sep=0pt, minimum size=8pt] at (5.1,0) {};
 \node[square, draw, inner sep=0pt, minimum size=8pt] at (6,0) {};
 ...
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (2.3,1) {};
 ...
 \node[square, draw, inner sep=0pt, minimum size=8pt] at (1.4,1) {};
 \node[square, draw, inner sep=0pt, minimum size=8pt] at (2.6,1) {};
 \node[square, draw, inner sep=0pt, minimum size=8pt] at (3.5,1) {};
 \node[square, draw, inner sep=0pt, minimum size=8pt] at (4.6,1) {};
 \node[square, draw, inner sep=0pt, minimum size=8pt] at (5.4,1) {};

 % mesh motion
 \draw [dashed] (0,0.15) -- (0.2,1);
 \draw [dashed] (1,0.15) -- (1.1,1);
 \draw [dashed] (2.7,0.15) -- (2.3,1);
 \draw [dashed] (4,0.15) -- (3.8,1);
 \draw [dashed] (5.1,0.15) -- (4.9,1);
 \draw [dashed] (6,0.15) -- (5.8,1);

 % particle motion
 \draw [dotted] (0,0.15) -- (0.5,0.85);
 \draw [dotted] (1,0.15) -- (1.4,0.85);
 \draw [dotted] (2.7,0.15) -- (2.6,0.85);
 ...
 \draw [dotted] (3.5,-1) -- (4.0,-1);
 \draw [dashed] (3.5,-1.5) -- (4.0,-1.5);
