...
\column{.5\textwidth}
\begin{center}
  \includegraphics[scale=0.2]{images/withALE.png}
  \caption{\scriptsize with ALE}

  \vspace{0.5cm}
  \includegraphics[scale=0.2]{images/withoutALE.png}
  \caption{\scriptsize without ALE}
\end{center}
\end{columns}
...
\begin{tikzpicture}[node distance = 1.0cm,auto]
    ...
    \node [right of=step3, node distance=4cm] (initialLoop) {};
    \node [right of=step10, node distance=4cm] (finalLoop) {};
    \node [right of=step6, node distance=5.5cm] (textLoop) {};
    ...
    \path [line,dashed] (step10) -- (finalLoop) -- (initialLoop) |- (step3);
\end{tikzpicture}
\end{center}
\end{frame}
