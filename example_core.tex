...
\begin{itemize}
 \justifying
 \item To develop a Finite Element code for axisymmetric vorticity-streamfunction formulation 
...
\hspace{0.5cm}  7. Axisymmetric flow
\end{column}
\end{columns}
\end{center}
\small
...
Vorticity Transport:
\begin{equation*}
\frac{D \omega_{\theta}}{D t}
	= 
	\frac{\omega_{\theta} v_r}{r}
	+
	\frac{1}{Re}
	\bigg[
	\frac{1}{r}\frac{\partial}{\partial r} r 
	\frac{\partial {\omega_{\theta}}}{\partial r}
	+
	\frac{\partial^2 \omega_{\theta}}{\partial z^2}
	-
	\frac{\omega_{\theta}}{r^2}
	\bigg]
\end{equation*}
...
where D/Dt is the material derivator operator.
