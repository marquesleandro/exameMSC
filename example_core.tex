...
\column{.35\textwidth}
\justifying
In ALE description (c), the referential frame moves with an arbitrary velocity that does not necessary represents the Lagrangian (a) or Eulerian (b) description
...
\begin{tikzpicture}
 ...
 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (0,4) {};
 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (1,4) {};
 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (2.7,4) {};
 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (4,4) {};
 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (5.1,4) {};
 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (6,4) {};

 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (0,4) {};
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (1,4) {};
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (2.7,4) {};
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (4,4) {};
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (5.1,4) {};
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (6.0,4) {};

 % top line
 \draw (0.5,5) -- (5.4,5);

 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (0.5,5) {};
 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (1.4,5) {};
 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (2.3,5) {};
 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (3.5,5) {};
 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (4.6,5) {};
 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (5.4,5) {};

 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (0.5,5) {};
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (1.4,5) {};
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (2.3,5){};
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (3.5,5) {};
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (4.6,5) {};
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (5.4,5) {};

 % mesh motion
 \draw [dashed] (0,4)   -- (0.5,5)  ;
 \draw [dashed] (1,4)   -- (1.4,5)  ;
 \draw [dashed] (2.7,4) -- (2.3,5);
 \draw [dashed] (4,4)   -- (3.5,5)  ;
 \draw [dashed] (5.1,4) -- (4.6,5);
 \draw [dashed] (6,4)   -- (5.4,5)  ;

 % particle motion
 \draw [dotted] (0,4.15) -- (0.5,4.85);
 \draw [dotted] (1,4.15) -- (1.4,4.85);
 \draw [dotted] (2.7,4.15) -- (2.3,4.85);
 \draw [dotted] (4,4.15) -- (3.5,4.85);
 \draw [dotted] (5.1,4.15) -- (4.6,4.85);
 \draw [dotted] (6,4.15) -- (5.4,4.85):



 % Eulerian legend 
 \draw [latexnew-latex] (-0.3,4) -- (-0.3,5);
 \node at (-0.5,4.5) {t};
 \node at (3,3.5) {\scriptsize (a)};
 % -------------------------------------------------------------------
 ...
 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (0,2) {};
 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (1,2) {};
 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (2.7,2) {};
 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (4,2) {};
 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (5.1,2) {};
 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (6,2) {};

 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (0,2) {};
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (1,2) {};
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (2.7,2) {};
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (4,2) {};
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (5.1,2) {};
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (6.0,2) {};

 % top line
 \draw (0,3) -- (6,3);

 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (0.5,3) {};
 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (1.4,3) {};
 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (2.3,3) {};
 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (3.5,3) {};
 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (4.6,3) {};
 \node[square, fill=white, draw, inner sep=0pt, minimum size=8pt] at (5.4,3) {};

 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (0,3) {};
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (1,3) {};
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (2.7,3){};
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (4,3) {};
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (5.1,3) {};
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (6.0,3) {};

 % mesh motion
 \draw [dashed] (0,2)   -- (0,3)  ;
 \draw [dashed] (1,2)   -- (1,3)  ;
 \draw [dashed] (2.7,2) -- (2.7,3);
 \draw [dashed] (4,2)   -- (4,3)  ;
 \draw [dashed] (5.1,2) -- (5.1,3);
 \draw [dashed] (6,2)   -- (6,3)  ;

 % particle motion
 \draw [dotted] (0,2.15) -- (0.5,2.85);
 \draw [dotted] (1,2.15) -- (1.4,2.85);
 \draw [dotted] (2.7,2.15) -- (2.3,2.85);
 \draw [dotted] (4,2.15) -- (3.5,2.85);
 \draw [dotted] (5.1,2.15) -- (4.6,2.85);
 \draw [dotted] (6,2.15) -- (5.4,2.85):



 % Eulerian legend 
 \draw [latexnew-latex] (-0.3,2) -- (-0.3,3);
 \node at (-0.5,2.5) {t};
 \node at (3,1.5) {\scriptsize (b)};
 % -------------------------------------------------------------------
 ...
 \node at (-0.5,0.5) {t};
 \node at (3,-0.5) {\scriptsize (c)};
 

 % picture legend
 \node[square, draw, inner sep=0pt, minimum size=8pt] at (0.5,-1);
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (0.5,-1.5);
 \draw [dotted] (3.5,-1) -- (4.08,-1);
 \draw [dashed] (3.5,-1.5) -- (4.1,-1.5);

 \node at (1.5,-1) {\tiny material point};
 \node at (1.0,-1.5) {\tiny node};
 \node at (5.0,-1) {\tiny particle motion};
 \node at (4.9,-1.5) {\tiny mesh motion};
 % -------------------------------------------------------------------
