...
\begin{frame}
 \frametitle{\LARGE The semi-Lagragian Method}
...
\begin{tikzpicture}[scale=2.5]
 ...
 \draw[dashed,-stealth] (2.86,2.55) -- (3.12,2.72);
 ...
 \node[circle, fill=black, inner sep=0pt, minimum size=4.5pt] at (J) {};
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (2.95,0.65) {};
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (2.90,1.45) {};
 \node[circle, fill=black, inner sep=0pt, minimum size=4pt] at (2.4,1.05) {};

 \draw[-stealth] (J) edge (2.965,0.66);
 \draw[-stealth] (J) edge (2.91,1.43);
 \draw[-stealth] (J) edge (2.42,1.05);
 
 \node[draw=none, scale=0.8] at (3.27,0.97) {$\omega_{i}^{n+1}$};
 \node[draw=none, scale=0.8] at (3.05,0.66) {$\omega_{d}^{n}$};
 \node[draw=none, scale=0.8] at (3.0,1.44) {$\omega_{d}^{n}$};
 \node[draw=none, scale=0.8] at (2.41,1.13) {$\omega_{d}^{n}$};
 
 \node[draw=none, scale=0.6] at (3.0,0.74) {$1$};
 \node[draw=none, scale=0.6] at (3.07,1.158) {$2$};
 \node[draw=none, scale=0.6] at (2.6,1.05) {$3$};
 
 \node[draw=none, scale=0.9] at (3.7,1.0) {$domain$};
 \node[draw=none, scale=0.9] at (3.8,1.65) {$boundary$};
